...
if __name__ == '__main__':
    ali = AliPay(app_notify_url='http://127.0.0.1:5000/home',return_url='http://127.0.0.1:5000/home',appid='9021000136679325',app_private_key_path='siyao.txt',alipay_public_key_path='gongyao.txt')
    print  ('https://openapi-sandbox.dl.alipaydev.com/gateway.do?'+ali.direct_pay(subject='asdaasd',total_amount='0.01',out_trade_no='100000000'))
